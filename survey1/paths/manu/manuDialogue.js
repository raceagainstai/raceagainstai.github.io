...
let link2 = "Tracking_Solar.html";
let link3 = "RecyclingM_Lib.html";
let link4 = "RecyclingF_Lib.html";
...
//   } else if($(this).val() == 4) {
//     $('#nextPage').window.location = "Tracking_Solar.html";
//   } else if($(this).val() == 6) {
//     $('#nextPage').window.location = "RecyclingM_Lib.html";
//   } else if($(this).val() == 8) {
//     $('#nextPage').window.location = "RecyclingF_Lib.html";
//   }
// })
