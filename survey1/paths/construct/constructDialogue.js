...
//INTEREST  ///////////////////////////////////////////////////////////////////
let link1 = "Flood_Solar.html";
let link2 = "RecyclingM_Turk.html";
let link3 = "RecyclingF_Turk.html";
let link4 = "Recycling_Lib.html";
...
//   if($(this).val() == 2) {
//     $('#nextPage').window.location = "Flood_Solar.html";
//   } else if($(this).val() == 4) {
//     $('#nextPage').window.location = "RecyclingM_Turk.html";
//   } else if($(this).val() == 6) {
//     $('#nextPage').window.location = "RecyclingF_Turk.html";
//   } else if($(this).val() == 8) {
//     $('#nextPage').window.location = "Recycling_Lib.html";
//   }
// })
